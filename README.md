...
## How it was made
Every string was translated one by one, by hand. To speed up the work I used AI tools (such as Gemini) and translators like DeepL, together with dictionaries.
...
The `CozetteVector` font is by the [Cozette Contributors](https://github.com/the-moonwitch/Cozette?tab=MIT-1-ov-file) and is included under its own license.
